                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:Button class="btn btn-success" ID="Button1" runat="server" Text="Activate" />
                                        <asp:Button class="btn btn-danger" ID="Button2" runat="server" Text="Delete" />
                                        <asp:Button class="btn btn-warning" ID="Button3" runat="server" Text="Pending" />
                                    </div>
                                </div>
                            </div>
                            </div>
